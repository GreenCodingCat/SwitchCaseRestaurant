...
public class SwitchcaseResturant {
    ...
    public static void main(String[] args) {
        ...
        String drinkString = "nothing";
        String breakfastString = "nothing";
        String lunchString = "nothing";
        String supperString = "nothing";
        String snackString = "nothing";
        ...
        while(loop == 1){
            ...
            System.out.println("Would you like a drink ((1)y or (2)n)");
            i = probe.nextInt();
            switch (i){
                case 1: beverage = 1;
                    break;
            ...
            System.out.println("");
            System.out.println("Would you like breakfast today? ((1)y or (2)n)");
            i = probe.nextInt();
            switch (i){
                case 1: eggs = 1;
                    break;
            ...
            while (eggs == 1){
                ...
                switch(breakfast){
                    ...
                    case 2: breakfastString = "The Slayer's Breakfast";
                        break;
                    case 3: breakfastString = "Swallower's Revenge";
                        break;
            ...
            System.out.println("");
            System.out.println("Would you like lunch today? ((1)y or (2)n)");
            i = probe.nextInt();
            switch (i){
                case 1: sandwich = 1;
                    break;
            ...
            System.out.println("");
            System.out.println("Would you like dinner today? ((1)y or (2)n)");
            i = probe.nextInt();
            switch (i){
                case 1: steak = 1;
                    break;
            ...
            System.out.println("");
            System.out.println("Would you like a snack today? ((1)y or (2)n)");
            i = probe.nextInt();
            switch (i){
                case 1: cracker = 1;
                    break;
            ...
            totalsilver = drinkcost + snackcost;
            totalgold = breakfastcost + lunchcost + suppercost;
        
            System.out.println("");
            //System.out.println("<---------------------- Recipt ---------------------->");
            //System.out.println("|                                                    |");
            System.out.println(" -Your Drink was: " +drinkString+ " it costed: " +drinkcost+ " Silver Pieces");
            System.out.println(" -Your Breakfast was: " +breakfastString+ " it costed: " +breakfastcost+ " Gold Pieces");
            System.out.println(" -Your Lunch was: " +lunchString+ " it costed: " +lunchcost+ " Gold Pieces");
            System.out.println(" -Your Supper was: " +supperString+ " it costed: " +suppercost+ " Gold Pieces");
            System.out.println(" -Your Snack was: " +snackString+ " it coasted: " +snackcost+ " Silver Pieces");
            System.out.println(" -Your total price was: " +totalgold+ " Gold Pieces and " +totalsilver+ " Silver Pieces.");
            
            System.out.println("");
            System.out.println("Would you like to order again? ((1)y or (2)n)");
            i = probe.nextInt();
            switch(i){
                case 1: loop = 1;
                    break;
